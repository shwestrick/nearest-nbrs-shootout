...
val _ = print ("loading " ^ infile ^ "\n")
val (input, tm) = Util.getTime (fn _ => ParseFile.readSequencePoint2d infile)
val _ = print ("loaded input in " ^ Time.fmt 4 tm ^ "s\n")
val _ = print ("size " ^ Int.toString (Seq.length input) ^ "\n")
